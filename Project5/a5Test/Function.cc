...
void Function :: Print () {
	string enumText[] = {"PushInt", "PushDouble", "ToDouble", "ToDouble2Down", "IntUnaryMinus", "IntMinus", "IntPlus", 
	"IntDivide", "IntMultiply", "DblUnaryMinus", "DblMinus", "DblPlus", "DblDivide", "DblMultiply"};
   for(int i=0; i<numOps; i++){
       cout << enumText[opList[i].myOp] << " at index " << opList[i].recInput << " for given record " << endl;
       cout << "Original litInput is: " << opList[i].litInput << endl;
   }
